                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="cek_login.php" method="post">
                                        <div class="form-group"><label class="small mb-1" for="username">Username / Kode Dosen</label><input class="form-control py-4" id="username" type="text" placeholder="Username/Kode Dosen" name="username" /></div>
    ...
    <footer class="py-4 bg-light mt-auto">
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-between small">
                <div class="text-muted">Copyright &copy; Wijaya Husada <?= date('Y'); ?></div>
                <div>
