                            ...
                            <div class="card-body">
                                <form action="upload.php" method="post" enctype="multipart/form-data">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  value='<?= $_GET['id_p']?>' name="id_penelitian" required>
                                    <input type="text" class="form-control"  value='<?= $_SESSION['username']?>' name="nim" required>
