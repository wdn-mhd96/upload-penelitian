        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                ...
                if (mysqli_num_rows($ada) > 0) {
                    echo "<center><h3><span class='badge badge-warning'>Anda memiliki " . $p . " penelitan </span></h3></center>";
                    echo "<center><h3><span class='badge badge-warning'><a href='tambah_surat.php'>Tambah penelitian</a></span></h3></center>";
                } else {
                    echo "<center><h3><span class='badge badge-warning'><a href='tambah_surat.php'>Tambah penelitian</a></span></h3></center>";
                }
                ?>
