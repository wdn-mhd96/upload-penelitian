...
$columns = array(
    ...
    array(  'db' => 'id_pengmas',
            ...
            'formatter' => function($d, $row) {
                return '<a href="edit_pengmas.php?id='.$d.'" class="btn btn-sm btn-warning mr-1" data-toggle="tooltip" data-placement="top" title="Edit data Pengmas"><i class="fas fa-pen"></i></a>';
                // <br><a onclick="return confirm(`yakin hapus data pengmas?`);"href="hapus_pengmas.php?id='.$d.'" class="badge badge-danger">Hapus</a>';
            }
         ),
);
