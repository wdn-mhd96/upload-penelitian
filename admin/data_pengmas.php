...
$columns = array(
    ...
    array(  'db' => 'id_pengmas',
            ...
            'formatter' => function($d, $row) {
                return '<a href="edit_pengmas.php?id='.$d.'" class="badge badge-warning">EDIT</a><br><a onclick="return confirm(`yakin hapus data pengmas?`);"href="hapus_pengmas.php?id='.$d.'" class="badge badge-danger">Hapus</a>';
            }
         ),
);
